      ...
      <div className="space-y-4">
        <div className="flex flex-col sm:flex-row gap-3 sm:items-center">
          ...
          <select
            ...
            className="w-full sm:w-auto min-w-[180px] px-4 py-2.5 border border-slate-200 rounded-xl bg-white text-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-500/25 focus:border-blue-500"
        ...
        {filtered.length === 0 ? (
          <div className="rounded-2xl bg-slate-50 border border-slate-100 px-8 py-16 text-center">
            ...
            <button
              ...
              className="mt-6 px-5 py-2.5 rounded-lg text-sm font-medium text-blue-800 bg-blue-50 hover:bg-blue-100 transition-colors"
            >
              Ver todas
            </button>
          </div>
            ...
            {filtered.map((o, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="p-5">
                    <h2 className="font-semibold text-slate-900 line-clamp-2 group-hover:text-blue-800 transition-colors">
                      {o.titulo}
                    </h2>
                    ...
                    <p className="mt-4 text-sm font-medium text-blue-700 group-hover:text-blue-800 flex items-center gap-1">
                      Ver oferta
